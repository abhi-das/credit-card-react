...
import { cardFormatNumbers, cardValidation, getCardTypeByValue, getImageMeta, INVALID_CARD_ICON, removeSpaces, UNKNOWN_CARD_ICON } from "../../utils/card";
...
const CreditCard = (props: CreditCardDefaultProps) => {
    ...
    const { apiData, isApiDataLoading, apiError } = useFetchData('https://sumup-op-hiring-test.s3.eu-west-1.amazonaws.com/api-mock/cards-dictionary.json?request_id=1645556315');
    // Form Values
    ...
    const cardNumberAriaLabel = props.cardNumberAriaLabel || 'Credit card number';
